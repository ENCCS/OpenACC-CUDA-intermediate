...
c	PARAMETER (ttarget=60.0)
	PARAMETER (ttarget=6.0)
...
C$OMP PARALLEL SHARED (kmax,jmax,imax,nn,a,p,b,c,bnd,wrk1,wrk2,
C$OMP&  omega,gosa) PRIVATE (k,j,i,s0,ss,gosa1,loop) 
      DO loop=1,nn
C$OMP BARRIER
C$OMP MASTER
         gosa=0.0
