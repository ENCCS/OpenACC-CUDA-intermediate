...
c-------------------------------------------------------------------*/
    ...
    /* Here are some summed array sizes that we will use as 
     * offsets within some pointer arrays
     * For convenience, we start at the smallest level and work up,
     * in contrast to the the above top-down approach.
...
c-------------------------------------------------------------------*/
    ...
    // TODO: Transfer data from device to host for I/O
