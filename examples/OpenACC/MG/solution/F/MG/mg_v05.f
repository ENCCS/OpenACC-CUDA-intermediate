...
!$acc& private(r1,r2) copyin(r,c) copy(u)
      do i3=2,n3-1
         do i2=2,n2-1
            do i1=1,n1
...
!$acc parallel loop vector_length(NTHREADS)
!$acc& private(x1,y1) copyin(r) copyout(s)
      do  j3=2,m3j-1
         i3 = 2*j3-d3
         do  j2=2,m2j-1
            i2 = 2*j2-d2
...
!$acc parallel loop vector_length(NTHREADS)
!$acc& private(z1,z2,z3) copyin(z) copy(u)
         do  i3=1,mm3-1
            do  i2=1,mm2-1
...
!$acc parallel loop vector_length(NTHREADS)
!$acc& private(a) reduction(+:s) reduction(max:rnmu) copyin(r)
      do  i3=2,n3-1
         do  i2=2,n2-1
            do  i1=2,n1-1
               s=s+r(i1,i2,i3)**2
