...
c      Define this to use the original code with the private temporary
c      array.
...
#undef Resid_original
      ...
      INTEGER ni,nj,nk,n12,n123,i123,i12
...
!$acc parallel loop vector_length(NTHREADS)
!$acc& present(u,r,v,a) private(i123,i1,i2,i3,i12)
#if 0
      do i3=2,n3-1
         do i2=2,n2-1
            do i1=2,n1-1
...
!$acc parallel present(z) copyin(jg)
!$acc loop
      do  i=mm,mm0,-1
